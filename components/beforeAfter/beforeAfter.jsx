            ...
            >
                <div className="flex justify-between border border-white_700 dark:border-gray py-4 px-1 cs:px-4">
                    <div className="flex flex-col justify-between items-start">
                        <h2 className="text-lg cs:text-xl font-semibold">
                        ...
                        <div className="flex justify-evenly gap-x-2">
                            {item.selectedServices.map((service, index) => (
                                <div
                                    key={index}
                                    className="w-auto h-8 p-2 text-xs cs:text-sm border border-black dark:border-white rounded-3xl flex justify-center items-center"
                                >
                    ...
                    <div className="w-50vw h-32 cs:w-48 cs:h-32 relative">
                        <Image
    ...
    return (
        ...
        >
            <div
                ...
                w-full h-auto clg:min-w-940 clg:max-w-1250 cxl:w-85/100 py-4`}
            >
                <div className="flex justify-start gap-x-2 cs:gap-x-4">
                    <button
                        className={`${category === 'all' ? 'border-light_blue text-light_blue' : 'border-black dark:border-white'} 
                    border  rounded-3xl ml-1 px-2 cs:px-4 text-xs cs:text-sm`}
                        onClick={() => {
                            setCategory('all');
                        }}
                    >
                ...
                border border-black dark:border-white rounded-3xl p-1 cs:p-2 text-xs cs:text-sm`}
                        onClick={() => {
                            setCategory('implant');
                        }}
                    >
            ...
            <div className="mt-12 mb-8 cs:mt-20 mb-12">
