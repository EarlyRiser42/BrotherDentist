                ...
                >
                    ...
                    >
                        <div
                            ...
                            min-w-150 cs:w-3/4 sm:min-w-300 sm:h-8/10 clg:h-11/100 cxl:h-15/100"
                        >
                            <span className="text-xs cs:text-sm sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-white">
                                {page.home.p0}
                            </span>
                        </div>
                        <div className="flex flex-col justify-evenly w-50vw h-3/5 absolute left-2 top-12 cs:left-4 cs:top-16 sm:top-20 xl:left-20 xl:top-44 z-10 ">
