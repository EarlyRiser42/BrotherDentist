...
import { login, onSocialClick } from '@/app/[lang]/login/components/action';
...
export default function LoginForm({ lang, page }) {
    // 비밀번호 보이기 안보이기
        ...
        <div className="h-90dvh min-h-640 flex flex-col justify-center items-center">
            <div className="space-y-4 w-full flex flex-col justify-center items-center">
                ...
                <div className="w-9/10 cs:w-80">
                    <button
                        className="relative border border-white_500 bg-white hover:bg-opacity-90 text-black font-bold py-2 px-4 rounded-3xl inline-flex justify-center items-center w-full h-12 mb-4"
                ...
                >
                    ...
                    <div className="relative w-9/10 cs:w-80 max-w-xl flex justify-between rounded-lg md:max-w-md">
                        <input
                            ...
                            border border-white_500 text-black dark:text-white rounded-xl bg-light_gray dark:bg-gray_400 text-lg"
                            name="password"
                            type="password"
                    ...
                    <div className="w-9/10 cs:w-80">
                        <button
                            type="submit"
                            className="inline-flex items-center justify-center w-full h-10 px-5 mb-4 py-2.5 text-sm font-medium rounded-3xl cursor-pointer no-underline
                            border border-white_500 bg-white text-black hover:bg-opacity-90"
                        >
                            {page.login.login}
                        </button>
                        <button
                            className="inline-flex items-center justify-center w-full h-10 px-5 py-2.5 text-sm font-medium rounded-3xl cursor-pointer no-underline
